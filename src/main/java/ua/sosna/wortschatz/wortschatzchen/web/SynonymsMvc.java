...
public class SynonymsMvc {
	...
	public String showItemsList(@PathVariable Long wordId, Model model) {
		List<Synonyms> list;
		Word baseWord = null;
	...
	public String createItem(@PathVariable Long wordId, Model model) {
	...
	public String save(@PathVariable Long wordId, @ModelAttribute Synonyms item, Model model) {
